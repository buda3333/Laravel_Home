...
class ServicePermissionLayout extends Rows
{
    /**
     * @var User|null
     */
    ...
    {
        $this->service = $this->query->get('service');
    ...
    {
        return CheckBox::make('permissions.'.base64_encode($chunks->get('description')))
    ...
    {
        return optional($this->service)->hasAccess($slug) === true && $value === false;
    }
}
