...
<form id="regForm" action="{{ route('register.record') }}" method="post">
    ...
    <div class="tab">Специалисты:
        <label for="specialist">Specialist:</label>
        <select id="specialist" name="specialist_id" onchange="updateCalendars()">
        </select>
    </div>
    <div class="tab">Дата и время:
