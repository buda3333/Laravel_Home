...
<html lang="en">
<body>
<form action="{{ route('register.record4') }}" method="post" class="container">
    @csrf
    <h1>Записаться</h1>
    <h3>Ваши Данные</h3>
    <div class="service-buttons">
        @foreach ($specialists as $specialist)
            <button type="submit" class="service-button" id="{{ $specialist->id }}" name="specialist_id" value="{{ $specialist->id }}">
                {{ $specialist->name }}
            </button>
        @endforeach
    </div>
